...
useEffect(() => {
  ...
  return (
    <div 
      className="bg-cover bg-fixed relative lg:h-screen h-full"
      style={{
      ...
      <div className='relative w-10/12 mx-auto  py-10 h-full'>
          <h1 className='text-center pt-20 text-5xl text-extrabold text-[var(--primary-light)]'>Start Planning Your Meals</h1>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-4 gap-2'>
              ...
              <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3v-3z"></path>
                ...
                <div className="relative h-full lg:w-96 w-80 mx-auto  overflow-hidden bg-gray-500/70 rounded-sm p-2">
